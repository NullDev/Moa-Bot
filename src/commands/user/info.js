...
export default {
    ...
    async execute(interaction){
        ...
        const totalGuilds = guilds?.reduce((
            /** @type {any} */ acc, /** @type {any} */ guildCount,
        ) => Number(acc) + Number(guildCount), 0);
        const totalMembers = members?.reduce((
            /** @type {any} */ acc, /** @type {any} */ memberCount,
