 ...
 *
 * @param {String|Buffer|import("stream").Readable|Array<String|Buffer>} doc
 * @param {Object} [options={}]
 * @param {String} [options.command] LaTeX command to use (pdflatex or latex)
 * @param {String} [options.format] Output format (pdf or dvi)
 * @param {Boolean} [options.haltOnError] Whether to halt on error
 * @param {String} [options.bufSize] Buffer size for LaTeX process
...
const create = function(doc, options = {}){
    ...
    awaitDir((/** @type {any} */ err, /** @type {string} */ dirpath) => {
        if (err){
